import { Component, EventEmitter, Host, Listen, State, h, Event, Method, Fragment } from '@stencil/core';
  ...
  render() {
    return (
      <Host>
        ...
        <div data-state={this.isDialogVisible ? 'visible' : 'hidden'} class={'dialog'}>
